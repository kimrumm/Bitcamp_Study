...
----48. 담당업무가 ANALYST 인 사원보다 -> 여러명 all
--      급여가 적으면서 
--      업무가 ANALYST가 아닌 
--      사원들을 표시(사원번호, 이름, 담당 업무, 급여)하시오.

--49. 부하직원이 없는 사원의 이름을 표시하시오. -> mgr (empno)
...
--55. KING에게 보고하는 -> mgr = king 의 사원번호
--    사원의 이름과 급여를 표시하시오.
...
--58. 평균급여가 가장 적은 업무를 찾으시오. ->group by
