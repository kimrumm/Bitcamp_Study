...
public class FileUploadController {
	...
	final String UPLOAD_URI = "/uploadfile"; // 저장경로 상수표현
	...
	public String upload(
			...
			@RequestParam("report") MultipartFile report, Model model, HttpServletRequest request // 절대경로필요
	...
	public String upload(
		...
		System.out.println("3 학생이름 : " + report.getSname());
		System.out.println("3 파일이름 : " + report.getReport().getOriginalFilename());

		model.addAttribute("sno", getSno);
