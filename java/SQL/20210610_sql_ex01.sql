...
-- 6. 1981년 2월 20일 부터 1981년 5월 1일 사이에 입사한 -> 범위(날짜)
...
-- 부서번호가 20 또는 30인 사원의 이름, 급여와 부서번호를 출력, - 조건2
-- 이름순(오름차순)으로 출력하시오.
...
--10. 관리자가 없는 사원의 이름과 담당 업무를 출력하시오. ->mgr
select ename, job
from emp
where mgr is null
;
...
-- 급여(숫자) 및 커미션을 기준으로 내림차순 정렬하여 표시하시오. ->정렬
...
-- 14. 담당업무가 CLERK, 또는 SALESMAN이면서(and) 조건1.
-- 급여가 $1600, $950 또는 $1300이 아닌 
-- 사원의 이름, 담당업무, 급여를 출력하시오.
select ename, job, sal
from emp
--where (job like'%CLERK%' or job like '%SALESMAN%' and 
--sal like '%1600%' or sal like '%950%' or sal not like '%1300%' )
where (job='CLERK' or job='SALESMAN') AND SAL NOT IN (1600,960,1300)
;
